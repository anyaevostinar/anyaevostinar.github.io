...
permalink: /classes/361-f26/syllabus
---
...
* [Biological Bits by Alan Dorin](/classes/361-f26/BiologicalBits_PDF_edn1.pdf)
    * Note, there is an Apple Books edition that has interactive features which is nice but not required.
* [Artificial Life Online Expo](https://alife-expo.org/index.html)
...
Welcome to Artificial Life and Digital Evolution! In this course you'll learn how we can use a computational and algorithmic approach to understand the dynamics of biological life, both as it currently is on Earth and as it could be! We'll explore the field of artificial life (from chemistry to art to evolution and more) and implement some of the ideas in code. By the end of the course, you will develop skills in interdisciplinary thinking, communication, scientific computing, and using simulations to discover the unasked questions of life.
...
* Create your own larger artificial simulation to explore a question of your own design, and present your findings to the class
...
I’ll be using a version of *specifications grading* this term for the programming assignments. Each assessment that you hand in will receive narrative feedback and be marked on the following scale:
...
Requirements will be in one of two categories:
...
Your final course grade will be based on how many advanced and core requirements you have satisfied as well as how many engagement credits you earned. The table below shows the **minimum** requirement for each letter grade for each category. To calculate your grade, I will find the highest letter grade for which you have met all requirements. For example, if you satisfied 5 advanced objectives, 5 core objectives and had 55 engagement credits, you would receive a B+ due to the missing core objective. 
...
**Preparation work** cannot be submitted late. If you miss the submission for a given day, you cannot earn the engagement credit for that work. (There will be other ways of making up engagement credits.)
...
Specifically, the programming assignments in this course are designed to help you wrestle with the course material. These assignments assume that **you will do the intellectual work required to complete them**, which includes processing the assignments as they're presented, actively engaging in the class material, and developing and testing your own ideas in your programming. However, this class assumes you are already familiar with the fundamentals of programming, just in another language, and the jump to C++ is a heavy lift and not a fundamental goal of the course. Therefore, you will be allowed to use generative AI to help you with the C++ syntax and other programming issues that are not directly related to the course material. You may not, however, use it to complete the reading and writing components of the course.

Clearly unacceptable:
* Having gen AI summarize a reading and write a prep check answer for you.

Clearly acceptable:
* Having VSCode's Copilot or other genAI tools help you with C++ syntax or errors.
