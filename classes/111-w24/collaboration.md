---
layout: page
title: CS111 Data Structures W24 Collaboration Policies
permalink: /classes/111-w24/collaboration
---
...
* Reading checks: Often there will be multiple choice reading checks embedded in the reading or on Moodle. You can get help from anyone and anything on these reading checks though the ones on Moodle you can only attempt once, so you should make it count (the ones embedded in the reading allow unlimited attempts). These don't contribute to your grade; they are just a way for me to see where everyone is before class.  
