...
permalink: /classes/257-w26/lab-proposal
---
...
2. Discuss with your team your answers to the following:
    1. Who is interested in each of the [required roles](project-proposal#team-contract-requirements)
...
3. Once you've found a dataset, make sure to record the following since you'll need them later:
    * URL
    * date downloaded
    * authorship
