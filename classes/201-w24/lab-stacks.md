...
layout: page
title: Stack Lab
permalink: /classes/201-w24/stacks
---
...
* Create a new folder in your STUWORK/username folder called `StackLab`
...
a. Create a `BookStack` class in your folder.

b. Declare three Integers for number of books to read, number of books already read, and the array size, as well as one String array instance variable:
```
String[] bookArray;
```
