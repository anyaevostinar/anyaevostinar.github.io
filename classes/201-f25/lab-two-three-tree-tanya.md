...
layout: page
title: 2-3 Tree Lab
permalink: /classes/201-f25/two-three-tree-lab-tanya
published: true
---
...
## Setup
Copy the [starter code `TwoThreeTreeLab.kt`](/classes/201-f25/TwoThreeTreeLab.kt) to a folder on your computer or `COURSES` drive on the lab computer and open in VSCode.
