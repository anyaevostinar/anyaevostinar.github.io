---
layout: page
title: CS111 Data Structures F24 Collaboration Policies
permalink: /classes/111-f24/collaboration
---
...
* Reading checks: Often there will be reading checks embedded in the reading or on Moodle. You can get help from anyone and anything on these reading checks. These don't contribute to your grade; they are just a way for me to see where everyone is before class.  
...
* Quizzes: In-class quizzes are intended to assess your understanding of the course content up to that point. They will include conceptual and written code questions. You should not discuss these quizzes with anyone in the class until the quizzes are returned, although you may ask me about them privately via email or CampusWire.
...
However, if the assignment is "implement binary search" and you can't remember exactly how the for-loop syntax works, it might be allowed to look on StackOverflow, though it would be better to use the textbook and the reference sheet that you've made.
What would absolutely not be allowed would be to look up and copy a Python implementation of binary search from StackOverflow or any other site, since the point of the assignment was for you to implement it yourself.
...
Alyssa and Ben sit next to each other with their laptops while working on a problem set. They talk in general terms about different approaches to doing the problem set. They draw diagrams on the whiteboard. When Alyssa discovers a useful class in the Python library, she mentions it to Ben. When Ben finds a StackOverflow answer that helps solve an error (but doesn't have code directly relating to the problem set), he sends the URL to Alyssa. **OK**.
...
You also may not share quizzes or solutions to quizzes from this class with anyone outside of the class, or ask anyone who has taken CS111 in the past to look at their old quizzes or assignments.
