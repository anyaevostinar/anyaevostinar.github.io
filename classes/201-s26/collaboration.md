...
* Homework: Homework generally consists of larger projects than labs and gives you the chance to creatively problem solve and apply ideas from class. You will often be allowed to consult with a partner on an assignment, but you must still **type the code all yourself and submit individually**.
...
For example, looking at an example of a for-loop in Kotlin on StackOverflow may or may not be allowed depending on the assignment. 
...
What would absolutely not be allowed would be to look up and copy a Kotlin implementation of breadth-first search from StackOverflow or any other site, since the point of the assignment was for you to implement it yourself.
...
Note all of these scenarios assume the students aren't assigned as homework partners.
