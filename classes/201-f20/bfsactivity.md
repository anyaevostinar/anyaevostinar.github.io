...
## Logistics
This is a lab assignment that you'll be handing in on Moodle. You should complete it on Wednesday Oct 14th, but it isn't due until Friday Oct 16th at 5:00pm Central.

Please create a new Repl project and make it private. Upload the [starter code](/classes/201-f20/BFS-Activity-Starter.zip) for the activity.
