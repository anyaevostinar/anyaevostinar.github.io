---
layout: page
title: CS111 Introduction to Computer Science W26 Syllabus
permalink: /classes/111-w26/syllabus
---
...
* Readings, which will introduce ideas and provide details. There will be reading checks for you to submit before class each day. 
...
* Programming assignments where you complete more extended projects to provide opportunities to design solutions and see the ideas from class applied in real contexts. You will complete these individually with the option of having a "study buddy" partner (see the [Collaboration](collaboration) guidelines and individual assignments for more details)
* In-class exams for you to demonstrate your understanding of specific learning objectives.
* Final project, where you pull together everything you've learned to create something larger and hopefully fun.
...
In many of these activities you'll have the option to work collaboratively, and throughout the course you'll have assigned programming partners who you will work on the labs with. 
...
* **RR**: Revise or retake (does not meet the requirements yet)
...
The table below shows the **minimum** requirement for each letter grade for each category. To calculate your grade, I will find the highest letter grade for which you have met **all** requirements. For example, if you satisfied 18 advanced objectives, 20 core objectives and had 55 engagement credits, you would receive a B+ due to the missing core objective. 
...
|-------|----------|-------------|------------|
| Total| 11 (Exam) + 7 (HW) = 18 | 14 (Exam) + 7 (HW) = 21 | >54 |
| A | 17 | 21 | 50 |
| A- | 17 | 21 | <50 |
| B+ | 13 | 20 | 45 |
| B | 10  |  20 | 45|
...
You may *individually* [further revise](revision-process) that deliverable before the end of the term and request additional feedback via a form (linked [here](revision-process) as well as on the right sidebar of Moodle), however I make no guarantee of how quickly the resubmission will be assessed; it might not happen until the end of the term.
...
**All work including the final project must be submitted by the end of the last day of class as per College policy.** (Only retaking questions on the final exam is allowed during the exam period due to College policy.)
